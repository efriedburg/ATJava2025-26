...
public class HW13PartC {
    public static void draw(Graphics g) {
        ...
        double theta0 = 0.0;
        double r0 = Math.cos(2 * theta0);
        double x0 = scale * r0 * Math.cos(theta0);
        double y0 = scale * r0 * Math.sin(theta0);

        int previousX = centerX + (int) x0;
        int previousY = centerY - (int) y0;
        ...
        for (int i = 1; i <= steps; i++) {
            ...
            int currentX = centerX + (int) x;
            int currentY = centerY - (int) y;
